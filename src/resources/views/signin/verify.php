...
<body>
	<div class="full-box login-container cover p-5">
		<form action="<?= $this->serverPath ?>Signin/verifyDocument" method="POST" autocomplete="off" class="logInForm Nwas-validated">
		...
		<?php
			if(isset($_SESSION['messages'])) {
				switch ($_SESSION['messages']) {
					case 1:
						Helpers::message(
							'Usted ya se encuentra registrado en el sistema.',
							'danger'
						);
					break;
					case 2:
