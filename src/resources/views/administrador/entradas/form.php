...
<meta charset="UTF-8">
	...
	?>
    <title><?= $update ? 'Entradas - Actualizar' : 'Entradas - Registrar'; ?></title>
</head>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="<?= $this->serverPath ?>Entradas">Entradas</a></li>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Formulario para <?= $update ? 'actualizar' : 'registrar'; ?> una Entrada                   
                            </div>
                            <div class="card-body">
                                <div class="container">
                                    <form id="form" action="<?= $this->serverPath ?><?= $update ? 'Entradas/edit' : 'Entradas/create'; ?>" method="POST" autocomplete="off" class="Nwas-validated mt-1">                                                                       
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Ingrese una breve descripción que justifique la entrada realizado." rows="3"><?php if ($update) { ?><?= $_SESSION['producto'][0]->productoDescripcion; ?><?php } ?></textarea>
                                            <div><span class="help-block"></span></div>                                            
                                        </div>
                                        <br>
                                        <div class="form-group text-center">
                                            <input type="submit" value="<?= $update ? 'Actualizar' : 'Registrar'; ?>" class="btn btn-info">
                                            <a href="<?= $this->serverPath ?>Entradas" class="btn btn-danger">Cancelar</a>                                      
                                        </div>
                                        <noscript>
                                            <div class="form-group text-center">
