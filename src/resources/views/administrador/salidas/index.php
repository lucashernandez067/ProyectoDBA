                        ...
                        <?php
                            if(isset($_SESSION['messages'])) {
                                switch ($_SESSION['messages']) {
                                    ...
                                    case 2:
                                        Helpers::alert(
                                            'No se ha podido registrar el salida.',
                                            'error'                                         
                                        );
                                        Helpers::message(
                                ...
                                <table id="dataTable" class="table table-hover table-responsive-sm table-responsive-md"
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $salida->fk_id_Producto = self::findProducto($salida->fk_id_Producto);
                                            $salida->fk_usuarioDocumento = self::findUsuario($salida->fk_usuarioDocumento);            
                                        ?>
                                        <tr>
                                            <td><?= $salida->stockFechaRegistro; ?></td>
                                            <td><?= $salida->fk_id_Producto; ?></td>
                                            <td><?= $salida->stockCantidad; ?></td>
                                            <td><?= $salida->fk_usuarioDocumento; ?></td>
                                            <td><?= $salida->stockJustificacion; ?></td>
                                            <td>
                                                <a href="<?= $this->serverPath ?>Proveedores/actualizar/<?= $salida->id_ProveedorMaterial; ?>"
                                                    class="btn btn-outline-success"><i class="fas fa-pen"></i></a>
                                                <button
                                                    onclick="return confirmDelete(
                                                        '<?= $this->serverPath ?>Proveedores/eliminar/<?= $salida->id_ProveedorMaterial; ?>', 
                                                        'al proveedor <?= $salida->proveedorNombre; ?>'
                                                    )"
