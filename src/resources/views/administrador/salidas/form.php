...
<meta charset="UTF-8">
	...
	?>
    <title><?= $update ? 'Salidas - Actualizar' : 'Salidas - Registrar'; ?></title>
</head>
            ...
            <div id="bodyPath_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Gestión de Salidas <i class="text-danger fas fa-arrow-up"></i></h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="<?= $this->serverPath ?>Administrador">Administrador</a></li>
                            <li class="breadcrumb-item"><a href="<?= $this->serverPath ?>Salidas">Salidas</a></li>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Formulario para <?= $update ? 'actualizar' : 'registrar'; ?> una Salida                   
                            </div>
                            <div class="card-body">
                                <div class="container">
                                    <form id="form" action="<?= $this->serverPath ?><?= $update ? 'Salidas/edit' : 'Salidas/create'; ?>" method="POST" autocomplete="off" class="Nwas-validated mt-1">                                                                       
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Ingrese una breve descripción que justifique la salida realizado." rows="3"><?php if ($update) { ?><?= $_SESSION['producto'][0]->productoDescripcion; ?><?php } ?></textarea>
                                            <div><span class="help-block"></span></div>                                            
                                        </div>
                                        <br>
                                        <div class="form-group text-center">
                                            <input type="submit" value="<?= $update ? 'Actualizar' : 'Registrar'; ?>" class="btn btn-info">
                                            <a href="<?= $this->serverPath ?>Salidas" class="btn btn-danger">Cancelar</a>                                      
                                        </div>
                                        <noscript>
                                            <div class="form-group text-center">
