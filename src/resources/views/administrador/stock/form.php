...
<meta charset="UTF-8">
	...
	?>
    <title><?= $update ? 'Stock - Actualizar' : 'Stock - Registrar'; ?></title>
</head>
...
<body>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="<?= $this->serverPath ?>Stock">Stock</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="container">
                                    <form id="form" action="<?= $this->serverPath ?><?= $update ? 'Stock/edit' : 'Stock/create'; ?>" method="POST" autocomplete="off" class="Nwas-validated mt-1">                                                                       
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <a href="<?= $this->serverPath ?>Stock" class="btn btn-danger">Cancelar</a>                                      
                                        </div>
                                        <noscript>
                                            <div class="form-group text-center">
	...
	?>
	<script src="<?= $this->serverPath ?>resources/assets/js/StockValidations.js"></script>
</body>
