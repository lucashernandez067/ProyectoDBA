                            ...
                            if(isset($_SESSION['messages'])) {
                                switch ($_SESSION['messages']) {
                                    ...
                                    case 9:
                                        ...
                                        Helpers::message(
                                            '<b>¡Error!</b> Este proveedor se encuentra asociado a un producto.',
                                            'danger',
                                            'fa-check'
                                        );                                        
                                    break;                                    
                            ...
                            <div class="card-header">
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="ml-auto bd-highlight">
                                        <a href="<?= $this->serverPath ?>Proveedores/registrar"
                                ...
                                <table id="dataTable" class="table table-hover table-responsive-sm table-responsive-md"
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $proveedor->fk_id_estadoProveedor = self::findEstado($proveedor->fk_id_estadoProveedor);
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-sm"><?= $proveedor->fk_id_estadoProveedor; ?></div>
                                                    <div class="col-sm">
                                                        <a href="<?= $this->serverPath ?>Proveedores/cambiarEstado/<?= $proveedor->id_ProveedorMaterial; ?>" 
                                            ...
                                            <td>
                                                <a href="<?= $this->serverPath ?>Proveedores/actualizar/<?= $proveedor->id_ProveedorMaterial; ?>"
                                                    class="btn btn-outline-success"><i class="fas fa-pen"></i></a>
                                                <button
                                                    onclick="return confirmDelete(
                                                        '<?= $this->serverPath ?>Proveedores/eliminar/<?= $proveedor->id_ProveedorMaterial; ?>', 
                                                        'al proveedor <?= $proveedor->proveedorNombre; ?>'
                                                    )"
